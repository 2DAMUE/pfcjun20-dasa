...
public class ComunidadAutonomaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        imagen_pais=view.findViewById(R.id.imagen_ccaa );
    ...
    public void crearGrafico(){
        ...
        AnyChartView anyChartView = view.findViewById(R.id.grafico1);
        ...
        AnyChartView anyChartView1 = view.findViewById(R.id.grafico2);
        APIlib.getInstance().setActiveAnyChartView(anyChartView1);

        Cartesian cartesian = AnyChart.line();
        cartesian.height("260px");
